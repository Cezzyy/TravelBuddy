...
final guideDetailProvider = StreamProvider.family<Guide?, String>((ref, guideId) {
  final repo = ref.watch(guideRepositoryProvider);
  return repo.watchGuide(guideId);
});

/// Watch itinerary items for a guide.
final guideItineraryProvider = StreamProvider.family<List<GuideItineraryItem>, String>((ref, guideId) {
  final repo = ref.watch(guideItineraryRepositoryProvider);
  return repo.watchGuideItinerary(guideId);
});

/// Watch comments for a guide.
final guideCommentsProvider = StreamProvider.family<List<GuideComment>, String>((ref, guideId) {
...
final isGuideLikedProvider = StreamProvider.family<bool, String>((ref, guideId) {
